...
document.querySelector('.whatsapp-button').addEventListener('click', () => {
  const message = encodeURIComponent('Olá! Gostaria de mais informações, por favor.');
  const whatsappUrl = `https://wa.me/5581999999999?text=${message}`; // Substitua pelo número correto
